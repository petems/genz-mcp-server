"""
GenZ Chat tool - General development chat and collaborative thinking
...
from systemprompts import GENZ_CHAT_PROMPT
...
class GenZChatRequest(ToolRequest):
    """Request model for GenZ Chat tool"""
...
class GenZChatTool(SimpleTool):
    ...
    async def prepare_prompt(self, request: GenZChatRequest) -> str:
        """
    ...
    def format_response(self, response: str, request: GenZChatRequest, model_info: Optional[dict] = None) -> str:
        """
