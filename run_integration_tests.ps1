<#
.SYNOPSIS
    Integration test runner script for the GenZ MCP server on Windows.

.DESCRIPTION
    This PowerShell script prepares and runs integration tests for the GenZ MCP server:
...
.NOTES
    ...
    References          : https://github.com/petems/genz-mcp-server
#>
