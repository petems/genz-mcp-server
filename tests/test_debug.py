"""
Tests for the GenZ Debug tool using WorkflowTool architecture.
"""

from tools.genz_debug import GenZDebugInvestigationRequest, GenZDebugIssueTool
from tools.models import ToolModelCategory


class TestGenZDebugTool:
    """Test suite for GenZ Debug tool using WorkflowTool architecture."""

    def test_tool_metadata(self):
        """Test basic tool metadata and configuration."""
        tool = GenZDebugIssueTool()

        assert tool.get_name() == "genz_debug"
    ...
    def test_request_validation(self):
        ...
        step_request = GenZDebugInvestigationRequest(
    ...
    def test_relevant_context_handling(self):
        ...
        request = GenZDebugInvestigationRequest(
