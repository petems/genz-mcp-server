"""
Tests for GenZ Chat tool - validating SimpleTool architecture

This module contains unit tests to ensure that the GenZ Chat tool
(using SimpleTool architecture) maintains proper functionality.
"""
...
from tools.genz_chat import GenZChatRequest, GenZChatTool


class TestGenZChatTool:
    """Test suite for GenZ Chat tool"""

    def setup_method(self):
        """Set up test fixtures"""
        self.tool = GenZChatTool()

    def test_tool_metadata(self):
        """Test that tool metadata matches requirements"""
        assert self.tool.get_name() == "genz_chat"
    ...
    def test_request_model_validation(self):
        ...
        request = GenZChatRequest(**request_data)
    ...
    def test_required_fields(self):
        ...
        with pytest.raises(ValidationError):
            GenZChatRequest(model="anthropic/claude-3-opus")
    ...
    async def test_prompt_preparation(self):
        ...
        request = GenZChatRequest(prompt="Test prompt", files=[], use_websearch=True)
    ...
    def test_response_formatting(self):
        ...
        request = GenZChatRequest(prompt="Test")
...
class TestGenZChatRequestModel:
    """Test suite for GenZChatRequest model"""

    def test_field_descriptions(self):
        """Test that field descriptions are proper"""
        from tools.genz_chat import CHAT_FIELD_DESCRIPTIONS
    ...
    def test_inheritance(self):
        """Test that GenZChatRequest properly inherits from ToolRequest"""
